...
# 训练数据路径和验证数据路径
train_data_path = r"F:\00-TYE_FILE\4C_Project\GeKu\locationsupport\clasiifier_model_lower\train_data"
test_data_path = r"F:\00-TYE_FILE\4C_Project\GeKu\locationsupport\clasiifier_model_lower\test_data"
# eval_data_path = r"M:\DRIVE\test"
weights_save_path = r"weight_train1/996.pt"

device = "cuda:0" if torch.cuda.is_available() else "cpu"
# device = "cpu"
def train_eval_process(batch_size=10, epochs=100,accumulation_steps = 1):
    ...
    loss_func = CE_Focal_loss(class_num=2)
    ...
    for epoch in range(epochs):
        ...
        if epoch % 4 ==0:
            torch.save(net.state_dict(), fr"weight_train1\{epoch}.pt", _use_new_zipfile_serialization=False)
if __name__ == '__main__':
    train_eval_process(batch_size=50, epochs=2000,accumulation_steps = 1)
